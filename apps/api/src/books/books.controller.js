...
const create_book_dto_1 = require("../dto/book/create-book.dto");
const update_book_dto_1 = require("../dto/book/update-book.dto");
let BooksController = class BooksController {
    constructor(booksService) {
        this.booksService = booksService;
    }
    async add(createBookDto) {
...
], BooksController.prototype, "add", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
